    ...
    <div className="inicio">
      <section className="inicio-hero" aria-labelledby="titulo-inicio">
        <div className="hero-texto">
          ...
          <h1 id="titulo-inicio"><span>Tu sonrisa merece</span>{' '}<em>un cuidado personal.</em></h1>
          ...
          <div className="inicio-acciones">
            <a href={turno} className="inicio-boton" target="_blank" rel="noopener noreferrer">Solicitar turno <FlechaExterna /></a>
      ...
      <section className="inicio-seccion inicio-tratamientos" aria-labelledby="titulo-tratamientos">
        <div className="inicio-seccion-cabecera">
          ...
          <Link to="/especialidades" className="inicio-enlace">Todas las especialidades <FlechaExterna /></Link>
        </div>
        <div className="inicio-tratamientos-grid">
          {tratamientos.map(([numero, nombre, descripcion]) => (
            <article className="inicio-tratamiento" key={numero}>
              ...
              <a className="inicio-enlace" href={enlaceWhatsApp(`Hola, quisiera consultar por ${nombre.toLowerCase()}.`)} target="_blank" rel="noopener noreferrer" aria-label={`Consultar por ${nombre.toLowerCase()}`}>Consultar <FlechaExterna /></a>
            </article>
          ))}
        </div>
      </section>
