import './Inicio.css';
import videoFondo from '../assets/videos/fondo-video.mp4'; // Asegurate que este video exista en esa ruta
    ...
    <>
      <main className="inicio-hero">
        ...
        <div className="hero-overlay">
          ...
          <p>Cuidamos tu sonrisa con tecnología avanzada y atención personalizada.</p>
          <a
      ...
      <section className="seccion-equipo">
          ...
          <div className="odontologo">
            <img src={mauro} alt="Od. Mauro Baravalle" />
